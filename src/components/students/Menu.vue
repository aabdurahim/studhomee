  ...
  <section class="flex">
   <div class="panel w-1/5 bg-hero-text min-h-screen">
      ...
      <ul class="text-gray-400 cursor-pointer mx-7 py-5">
        ...
        <li :class="{ active: activeIndex === 4 }" @click="showTeacherList(), setActiveIndex(4)" class="hover:text-gray-100 text-lg py-3 transition ease-in-out delay-75">
          <font-awesome-icon icon="fa-solid fa-chalkboard-user" />
          <span class="mx-3">Teachers List</span>
        </li>
      ...
      <div>
        <div class="w-4/5 flex mx-auto py-2 px-5 rounded-md bg-logo mt-10 cursor-pointer">
...
import AcademicAttendance from './academic/Attendance.vue'
...
import ExamRoutine from './exam/ExamRoutine.vue'
...
export default {
  ...
  methods:{
    ...
    showTeacherList() {
      this.currentComponent = 'TeacherList';
    },
  },
};
</script>
